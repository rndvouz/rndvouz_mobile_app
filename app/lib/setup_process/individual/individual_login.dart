...
class IndividualSetupLogin extends StatefulWidget {
  const IndividualSetupLogin({Key? key}) : super(key: key);

  @override
  SetupLoginPageState createState() => SetupLoginPageState();
}

class SetupLoginPageState extends State<IndividualSetupLogin> {
