...
void addMerch(WidgetRef ref) {
  final db = FirebaseFirestore.instance.collection("merchandise");

  // final data = {"name": "Tokyo", "country": "Japan"};

  // final newDoc = db.add(data);

  for (var item in allGarments) {
    ...
    Merchandise newMerch = Merchandise(
      ...
      merchColors: item.merchColors,
      merchName: item.merchName,
      merchMeasurements: item.merchMeasurements,
